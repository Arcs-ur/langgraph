...
@app.post("/expert-analysis", 
          response_model=ExpertAnalysisResponse,
          summary="Expert CVE Analysis",
          description="Performs deep analysis on Type-3 CVEs while preserving original Type-1/2 data")
